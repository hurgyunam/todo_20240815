        ...
        <div className="flex flex-col ">
            <div className="flex justify-between px-[12px] 
                ...
                <div className="grid grid-cols-4 gap-[8px] items-center">
                    <HiOutlineSearch className="w-[24px] h-[24px]" color="#9FADBC" />
                    <IoIosNotifications className="w-[24px] h-[24px]" color="#9FADBC" />
                    <BsFillQuestionCircleFill className="w-[24px] h-[24px]" color="#9FADBC" />
                    <IoIosSettings className="w-[24px] h-[24px]" color="#9FADBC" />
                </div>
            </div>
        </div>
    )
